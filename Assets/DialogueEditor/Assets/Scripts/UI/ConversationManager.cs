...
namespace DialogueEditor
{
    public class ConversationManager : MonoBehaviour
    {
        ...
        private List<SpeechNode> _speechHistory;
        ...
        private void Awake()
        {
            ...
            _speechHistory = new List<SpeechNode>();
            TurnOffUI();
        }
        ...
        private void SetupSpeech(SpeechNode speech)
        {
            ...
            // Set name
            string localizedName = _currentStringTable[speech.Name].LocalizedValue;
            ...
            {
                string localizedSpeech = _currentStringTable[speech.Text].LocalizedValue;
                if (ScrollText)
                {
                    DialogueText.text = localizedSpeech;
                    m_targetScrollTextCount = localizedSpeech.Length + 1;
                    DialogueText.maxVisibleCharacters = 0;
                    m_elapsedScrollTime = 0f;
                    m_scrollIndex = 0;
                }
                ...
                {
                    DialogueText.text = localizedSpeech;
                    DialogueText.maxVisibleCharacters = localizedSpeech.Length + 1;
                }
            }
        ...
        public List<LocalizedSpeechNode> GetSpeechHistory()
        {
            var localizedSpeechHistory = new List<LocalizedSpeechNode>();
            foreach(var speech in _speechHistory)
            {
                string localizedName = _currentStringTable[speech.Name].LocalizedValue;
                string localizedSpeech = _currentStringTable[speech.Text].LocalizedValue;
                localizedSpeechHistory.Add(new LocalizedSpeechNode(){
                    Name = localizedName, 
                    Description = localizedSpeech
                });
            }

            return localizedSpeechHistory;            
        }
